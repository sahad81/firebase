  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButtonStyle = TextButton.styleFrom(
      backgroundColor: onPressed == null ? Theme.of(context).disabledColor : transparent
          ? color ? Theme.of(context).errorColor : Colors.transparent  : Theme.of(context).primaryColor,
      ...
      child: TextButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(buttonText ??'', textAlign: TextAlign.center, style: robotoBold.copyWith(
            color: transparent ? color ? Theme.of(context).cardColor :  Theme.of(context).primaryColor : Theme.of(context).cardColor,
